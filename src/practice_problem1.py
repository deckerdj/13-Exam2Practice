...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        self.contents = self.contents + additional_contents[0: x]
        return additional_contents[x:]
    ...
    def combined_box(self, other_box):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        x = self.contents + self.append_string(other_box.contents)
